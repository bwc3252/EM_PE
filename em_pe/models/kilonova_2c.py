...
class kilonova_2c(model_base):
    ...
    def set_params(self, params, t_bounds):
        ...
        for log_mej, vej, Tc, kappa in zip(
                [params["log_mej_red"], params["log_mej_blue"]],
                [params["vej_red"], params["vej_blue"]],
                [params["Tc_red"], params["Tc_blue"]],
                [5.0, 0.5]):
            mej = 10.0**log_mej
            a = self.fa([mej, vej])[0]
            b = self.fb([mej, vej])[0]
