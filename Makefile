...
test_kilonova_3c: directories
	...
	echo "python3 ${EM_PE_INSTALL_DIR}/em_pe/sampler.py --nprocs 2 --dat ./ --m kilonova_3c -v --f g.txt --f r.txt --f i.txt --f z.txt --f y.txt --f J.txt --f H.txt --f K.txt --min 10 --max 10 --out samples.txt --estimate-dist --fixed-param Tc_red 3700.0 --fixed-param Tc_purple 1300.0 --fixed-param Tc_blue 700.0 --correlate-dims log_mej_red vej_red --correlate-dims log_mej_purple vej_purple --correlate-dims log_mej_blue vej_blue --burn-in 10 10 --beta-start 0.1 --keep-npts 100000" > pe_runs/$@/sample.sh
