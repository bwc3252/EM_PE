...
test_woko2017: directories
	...
	echo "python ${EM_PE_INSTALL_DIR}/em_pe/sampler.py --epoch 5 --dat ./ --m woko2017 -v --f z.txt --min 20 --max 20 --out samples_z.txt --fixed_param dist 40.0" > pe_runs/$@/sample.sh
