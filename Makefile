...
simulation_injection_kn_interp_angle: directories
	...
	python3 ${EM_PE_INSTALL_DIR}/scripts/setup_simulation_injection.py --input-sim ${KN_SIM_DIR_AL}/Run_TP_dyn_all_lanth_wind2_all_md0.052780_vd0.164316_mw0.026494_vw0.174017_mags_2020-05-26.dat --tmin 0.1 --tmax 6.7 --n 30 --err 0.25 --out pe_runs/$@_$(shell date +%Y%m%d)/ --angular-bin 5 --dist 40.0 # --GW170817-times --GW170817-loc pe_runs/$@_$(shell date +%Y%m%d)/temp/
