...
#python em_pe/generate_posterior_samples.py --dat em_pe/tests/Data/ -v --m one_band_test 1 --f test_bandA.txt --out em_pe/tests/Data/posterior_samples2.txt --cutoff 1e-8
