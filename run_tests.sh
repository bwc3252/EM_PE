...
#python em_pe/generate_posterior_samples.py --min 100 --max 100 --dat em_pe/tests/Data/ -v --m two_band_test 1 --f test_bandA.txt --f test_bandB.txt --out em_pe/tests/Data/posterior_samples_2.txt --cutoff 1e-12
