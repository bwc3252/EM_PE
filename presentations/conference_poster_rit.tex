...
\headerbox{Objectives}{name=objectives,column=0,span=2,row=0}{
...
\headerbox{Light Curves}{name=lightcurves,column=1,below=objectives,bottomaligned=recovery}
{ % This block's bottom aligns with the bottom of the conclusion block

\begin{center}
\includegraphics[width=1\linewidth]{lc_real}
...
\begin{multicols}{2}
\begin{center}
\includegraphics[width=2.25\linewidth]{UML2}
